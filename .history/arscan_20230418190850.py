...
if __name__ == "__main__":
    ...
    # img1 = np.array(imgs)
    save_np_img(imgsc[0].squeeze(dim=0), "/Users/leilei/Desktop/ARTSCAN/", "output2.jpg")
    cv2.imwrite("output2.jpg",np.array(imgsc[0].squeeze(dim=0)))
    cv2.imwrite("output3.jpg",np.array(imgss[0].squeeze(dim=0)))
    cv2.imwrite("output4.jpg",np.array(imgsc_s[0].float().squeeze(dim=0).squeeze(dim=0)))
